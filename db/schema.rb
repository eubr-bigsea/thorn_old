...
ActiveRecord::Schema.define(version: 2018_01_11_190751) do

  create_table "card_grids", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.integer "user_id"
    t.text "configurations"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_card_grids_on_user_id"
  end
  ...
  create_table "users", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["card_grid_id"], name: "index_users_on_card_grid_id"
