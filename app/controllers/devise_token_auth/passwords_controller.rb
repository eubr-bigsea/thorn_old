module DeviseTokenAuth
  class PasswordsController < DeviseTokenAuth::ApplicationController
    ...
    def update
      ...
      unless @resource.email
        return render_update_error_token_expired
      end
      ...
      #ensure that email sent correspond to email in our database
      unless @resource.email == resource_params[:email]
        return render_update_error_email_not_match
      end
    ...
    def render_update_error_token_expired
      render json: {
        success: false,
        errors: [I18n.t("devise_token_auth.passwords.token_expired")]
      }, status: 401
    end

    def render_update_error_email_not_match
      render json: {
        success: false,
        errors: {email: [I18n.t("devise_token_auth.passwords.email_not_match")]}
      }, status: 401
    end
